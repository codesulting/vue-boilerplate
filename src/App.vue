  ...
  <div id="app">
    ...
    <section class="section--primary--alt">
      <div class="container">
        ...
        <p>Product is all you need. Anywhere - ever. Lorem ipsum dolor sit amet,
          consectetur adipisicing elit. Expedita sapiente hic voluptatum quo
          sunt totam accusamus distinctio minus aliquid quis!</p>
      </div>
    </section>
